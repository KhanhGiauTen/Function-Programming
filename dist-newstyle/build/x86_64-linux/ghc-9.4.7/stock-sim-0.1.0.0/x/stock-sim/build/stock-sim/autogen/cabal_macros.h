...
/* package stock-sim-0.1.0.0 */
#ifndef VERSION_stock_sim
#define VERSION_stock_sim "0.1.0.0"
#endif /* VERSION_stock_sim */
#ifndef MIN_VERSION_stock_sim
#define MIN_VERSION_stock_sim(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_stock_sim */
...
#define CURRENT_COMPONENT_ID "stock-sim-0.1.0.0-inplace-stock-sim"
